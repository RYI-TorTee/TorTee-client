...
export const getUsersAdmin = (PageIndex, PageSize, Search = "") => {
    return axiosInstance.get(`${RYI_URL}/Admin/users?PageSize=${PageSize}&Search=${Search}&PageIndex=${PageIndex}&IsDesc=true&OrderBy=createdDate`);
}

export const getMentorsAdmin = (PageIndex, PageSize, Search = "") => {
    return axiosInstance.get(`${RYI_URL}/Admin/mentors?PageSize=${PageSize}&Search=${Search}&PageIndex=${PageIndex}&IsDesc=true&OrderBy=createdDate`);
}

export const getTransactionAdmin = (PageIndex, PageSize, Search = "") => {
    return axiosInstance.get(`${RYI_URL}/Admin/transactions?PageSize=${PageSize}&Search=${Search}&PageIndex=${PageIndex}&IsDesc=true&OrderBy=createdDate`);
}

export const getStaffsAdmin = (PageIndex, pageSize, Search = "") => {
    return axiosInstance.get(`${RYI_URL}/Admin/staffs`, { PageIndex, pageSize, Search });
}
